 ...
 */
final class Version20200310103924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD src_photo VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP src_photo');
        $this->addSql('ALTER TABLE property ADD swimmingpool TINYINT(1) NOT NULL, ADD sauna TINYINT(1) NOT NULL, ADD wifi TINYINT(1) NOT NULL, ADD sport TINYINT(1) NOT NULL, ADD helipad TINYINT(1) NOT NULL, ADD terrasse TINYINT(1) NOT NULL, ADD balcon TINYINT(1) NOT NULL, ADD hifi TINYINT(1) NOT NULL, ADD television TINYINT(1) NOT NULL, ADD plageprox TINYINT(1) NOT NULL, ADD mervue TINYINT(1) NOT NULL, ADD montagnevue TINYINT(1) NOT NULL, ADD enville TINYINT(1) NOT NULL, ADD visavis TINYINT(1) NOT NULL, ADD plageprive TINYINT(1) NOT NULL, ADD pieddanseau TINYINT(1) NOT NULL, ADD centreville TINYINT(1) NOT NULL, ADD champetre TINYINT(1) NOT NULL, ADD typepropriete VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
